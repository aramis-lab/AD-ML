...
oasis_dx = pd.io.parsers.read_csv(path.join(oasis_tasks_dir, 'CN_vs_AD_diagnoses.tsv'), sep='\t')
oasis_dx['caps'] = "OASIS"
oasis_dx['cv_dx'] = oasis_dx.diagnosis + '_OASIS'

### Merging ###
merged = pd.concat([adni_dx, aibl_dx, oasis_dx])

output_dir = '/DATASETS/SUBJECTS/LEARNING_CURVE_ADNI_AIBL_OASIS'
