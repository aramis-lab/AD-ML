...
print 'ADNI'
path_bids = '/teams/ARAMIS/PROJECTS/CLINICA/CLINICA_datasets/BIDS/ADNI_BIDS_T1_PET'
subjects_diagnoses_list = '/teams/ARAMIS/PROJECTS/simona.bottani/ADML_paper/ADNI/lists_by_task/CN_vs_AD_diagnoses_generalization.tsv'
population_stats(path_bids, subjects_diagnoses_list, 'ADNI')

print 'AIBL'
path_bids = '/teams/ARAMIS/PROJECTS/CLINICA/CLINICA_datasets/BIDS/AIBL_BIDS'
subjects_diagnoses_list = '/teams/ARAMIS/PROJECTS/simona.bottani/ADML_paper/AIBL/lists_by_task/CN_vs_AD_diagnoses_generalization.tsv'
population_stats(path_bids, subjects_diagnoses_list, 'AIBL')

print 'OASIS'
path_bids = '/teams/ARAMIS/PROJECTS/CLINICA/CLINICA_datasets/BIDS/OASIS_BIDS'
subjects_diagnoses_list = '/teams/ARAMIS/PROJECTS/simona.bottani/ADML_paper/OASIS/lists_by_task/CN_vs_AD_diagnoses_generalization.tsv'
population_stats(path_bids, subjects_diagnoses_list, 'OASIS')
